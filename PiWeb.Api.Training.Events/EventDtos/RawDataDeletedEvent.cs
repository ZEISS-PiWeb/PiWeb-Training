...
/// <summary>
/// Represents the event that will be published after a raw data file was deleted.
/// </summary>
public record RawDataDeletedEvent
{
	#region properties
	...
	/// <summary>
	/// Gets the unique identifier of the inspection plan entity (part, characteristic, measurement, value) where the raw data was removed from.
	/// </summary>
